...
4. Add environment variable `GROK_API_KEY` in the Render dashboard
   (get this from console.x.ai — note the xAI API is pay-per-token,
   not free; the free tier only covers grok.com/X chat usage).
